        ...
        <div className='digits-background'>
          <Grid container centered stackable columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header inverted as='h3'>This address book enables any number of users to
                register and save their business contacts. You can only see the contacts you have created.</Header>
            </Grid.Column>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header inverted as='h3'>Each time you make a contact with a contact,
